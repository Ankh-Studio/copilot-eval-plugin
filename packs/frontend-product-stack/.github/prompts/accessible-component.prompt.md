...
1. **Semantic HTML5** elements for structure
...
6. **Color contrast** compliance (4.5:1 minimum)
7. **Touch targets** minimum 44px
8. **Error handling** with proper announcements
...
interface AccessibleComponentProps {
  // Define props with accessibility in mind
