...
**Score 1**: Poor data quality that may mislead or provide incorrect context.
...
**Score 1**: Poor relevance with mostly unrelated context.
...
**Score 1**: Limited coverage that doesn't adequately support the domain.
...
**Score 1**: Poor accessibility that hampers effective use.
