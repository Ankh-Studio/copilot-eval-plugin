...
**Score 1**: Poorly defined persona that leads to inconsistent behavior.
...
**Score 1**: Limited domain expertise that may provide incorrect guidance.
...
**Score 1**: Poor specialization that doesn't effectively handle intended tasks.
...
**Score 1**: Poor interaction quality that hampers effective use.
...
**Score 1**: Poor reliability with unpredictable or low-quality outputs.
**Score 0**: Unreliable performance that cannot be trusted.
